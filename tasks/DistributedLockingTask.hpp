...
#ifndef DISTRIBUTED_LOCKING_DISTRIBUTEDLOCKINGTASK_TASK_HPP
#define DISTRIBUTED_LOCKING_DISTRIBUTEDLOCKINGTASK_TASK_HPP
...
namespace distributed_locking {
     ...
     * Input port for FIPA letters from the MTS
     * \details
